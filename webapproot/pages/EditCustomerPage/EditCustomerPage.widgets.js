EditCustomerPage.widgets = {
	...
	deleteCustomerAssociateSVar: ["wm.ServiceVariable", {"operation":"deleteCustomerAssociate","service":"logs_ultimeyesvision_com_devDB"}, {"onSuccess":"deleteCustomerSVar"}, {
	...
	deleteCustomerSVar: ["wm.ServiceVariable", {"operation":"deleteCustomer","service":"logs_ultimeyesvision_com_devDB"}, {"onSuccess":"deleteCustomerSVarSuccess"}, {
	...
	customerproductassociateLiveVariable1: ["wm.LiveVariable", {"startUpdate":false,"type":"com.logs_ultimeyesvision_com_devdb.data.CustomerProductAssociate"}, {"onSuccess":"customerproductassociateLiveVariable1Success"}, {
		binding: ["wm.Binding", {}, {}, {
	...
	layoutBox1: ["wm.Layout", {"horizontalAlign":"left","verticalAlign":"top"}, {}, {
		customerDBForm: ["wm.DBForm", {"height":"100%","isCompositeKey":false,"readonly":true,"readonlyManager":true,"type":"com.logs_ultimeyesvision_com_devdb.data.Customer"}, {"onCancelEdit":"licenseFormPanel.hide","onEditNewObject":"licenseFormPanel.show","onEnterKeyPress":"customerDBForm.saveData","onInsertSuccess":"customerDBFormInsertSuccess"}, {
			...
			panel3: ["wm.Panel", {"autoScroll":true,"height":"100%","horizontalAlign":"left","verticalAlign":"top","width":"100%"}, {}, {
				...
				customerProductAssociateDBForm1: ["wm.DBForm", {"desktopHeight":"156px","fitToContentHeight":true,"height":"156px","isCompositeKey":false,"mobileHeight":"218px","padding":"0","readonly":true,"readonlyManager":true,"type":"com.logs_ultimeyesvision_com_devdb.data.CustomerProductAssociate"}, {"onEnterKeyPress":"customerProductAssociateDBForm1.saveData","onInsertSuccess":"getUnclaimedLogs"}, {
					idSubForm2: ["wm.SubForm", {"desktopHeight":"152px","editingMode":"one-to-one","fitToContentHeight":true,"formField":"id","height":"156px","isCompositeKey":true,"mobileHeight":"214px","padding":"0","readonly":true,"type":"com.logs_ultimeyesvision_com_devdb.data.CustomerProductAssociateId"}, {}, {
						...
						productEditor: ["wm.SelectMenu", {"caption":"ProductId","captionSize":"150px","dataField":"id","dataType":"com.logs_ultimeyesvision_com_devdb.data.Product","desktopHeight":"26px","displayExpression":"${name} + \" (v\" + ${version} + \")\"","displayField":"version","formField":"productId","height":"26px","readonly":true,"required":true,"width":"100%"}, {}, {
							binding: ["wm.Binding", {}, {}, {
